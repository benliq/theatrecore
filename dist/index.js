...
var SheetObjectTemplate = class {
  constructor(sheetTemplate, objectKey, nativeObject, config, actions) {
    ...
    this._actions = new import_dataverse6.Atom(actions);
  ...
  registerAction(name, action) {
    this._actions.setByPointer((p2) => p2[name], action);
  }
  getDefaultValues() {
...
var Sequence = class {
  constructor(_project, _sheet, _lengthD, _subUnitsPerUnitD, playbackController) {
    ...
    this._playbackControllerBox = new import_dataverse10.Atom(playbackController != null ? playbackController : new DefaultPlaybackController());
    this._prismOfStatePointer = (0, import_dataverse12.prism)(() => this._playbackControllerBox.prism.getValue().statePointer);
    ...
    this._positionFormatterD = (0, import_dataverse12.prism)(() => {
      const subUnitsPerUnit = (0, import_dataverse12.val)(this._subUnitsPerUnitD);
  ...
  pointerToPrism(path) {
    ...
    if (path.length > 1) {
      return (0, import_dataverse12.prism)(() => void 0);
    }
    const [prop] = path;
    if (prop === "length") {
      ...
      return (0, import_dataverse12.prism)(() => {
        return (0, import_dataverse12.val)(this._prismOfStatePointer.getValue().playing);
      });
    } else {
      return (0, import_dataverse12.prism)(() => void 0);
    }
  ...
  _makeRangeFromSequenceTemplate() {
    return (0, import_dataverse12.prism)(() => {
      return [0, (0, import_dataverse12.val)(this._lengthD)];
    });
  }
  playDynamicRange(rangeD, ticker) {
...
If you mean to reconfigure the object's config, set \`{reconfigure: true}\` in sheet.object("${key}", config, {reconfigure: true})`);
      ...
      if (opts == null ? void 0 : opts.actions) {
        Object.entries(opts.actions).forEach(([key2, action]) => {
          existingObject.template.registerAction(key2, action);
        });
      ...
      const sanitizedConfig = compound(config);
      const object = internal2.createObject(sanitizedPath, nativeObject, sanitizedConfig, opts == null ? void 0 : opts.actions);
      if (process.env.NODE_ENV !== "production") {
...
var Sheet = class {
  ...
  getSequence() {
    if (!this._sequence) {
      const lengthD = (0, import_dataverse13.prism)(() => {
        const unsanitized = (0, import_dataverse13.val)(this.project.pointers.historic.sheetsById[this.address.sheetId].sequence.length);
        return sanitizeSequenceLength(unsanitized);
      });
      const subUnitsPerUnitD = (0, import_dataverse13.prism)(() => {
        const unsanitized = (0, import_dataverse13.val)(this.project.pointers.historic.sheetsById[this.address.sheetId].sequence.subUnitsPerUnit);
...
var Project = class {
  constructor(id, config = {}, publicApi) {
    ...
    __publicField(this, "_sheetTemplates", new import_dataverse16.Atom({}));
    ...
    const onDiskStateAtom = new import_dataverse16.Atom({
      ahistoric: {
        ahistoricStuff: ""
      },
    ...
    this._pointerProxies = {
      historic: new import_dataverse15.PointerProxy(onDiskStateAtom.pointer.historic),
      ahistoric: new import_dataverse15.PointerProxy(onDiskStateAtom.pointer.ahistoric),
      ephemeral: new import_dataverse15.PointerProxy(onDiskStateAtom.pointer.ephemeral)
    };
    this.pointers = {
...
function onChange(pointer3, callback, rafDriver) {
  ...
  if ((0, import_dataverse17.isPointer)(pointer3)) {
    const pr = (0, import_dataverse18.pointerToPrism)(pointer3);
    return pr.onChange(ticker, callback, true);
  } else if ((0, import_dataverse18.isPrism)(pointer3)) {
...
function val7(pointer3) {
  if ((0, import_dataverse17.isPointer)(pointer3)) {
    return (0, import_dataverse18.pointerToPrism)(pointer3).getValue();
  } else {
